...
and keeps benign FPR near zero. Removing decoys from the broker's issuance path
makes every decoy touch a dead end. Rotation lowers activation but leaves harm high
after contact.
...
both sizes; Qwen3-8B shows lower activation and coalition harm.}
\label{fig:size}
\end{figure}
